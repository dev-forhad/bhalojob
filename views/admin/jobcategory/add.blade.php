        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <a href="{{ route('admin.jcIndex') }}">Category</a> <i class="fa fa-circle"></i> </li>
                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="{{ route('admin.jcIndex') }}" class="btn btn-xs btn-success"><i
                                        class="glyphicon glyphicon-plus"></i> All
                                    Category</a>
                            </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="{{ route('admin.jcSave') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
