...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Place <small>Place</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Place</span> </div>
                            <div class="actions">
                                <a href="{{ route('admin.jpCreate') }}" class="btn btn-xs btn-success"><i
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($jobplace as $each)
                                            <tr>
                                                ...
                                                <td>{{ $each->place }}</td>
                                                <td>
                                                    <a href="{{ url('admin/jpEdit/' . $each->id) }}"
