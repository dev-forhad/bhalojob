...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Industry <small>Industry</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="{{ route('admin.jiCreate') }}" class="btn btn-xs btn-success"><i
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($jobIndustry as $each)
                                            <tr>
                                                <th>{{ $i++ }}</th>
                                                <td>{{ $each->lan }}</td>
                                                <td>{{ $each->sub_name }} (<small style="color: green">{{ $each->name }}</small>)</td>
                                                <td>{{ $each->industry }}</td>
                                                <td>
                                                    <a href="{{ url('admin/jiEdit/' . $each->mainid) }}"  class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
                                                    <a onclick="return confirm('Are you sure you want to delete this item?');"   href="{{ url('admin/jiDelete/' . $each->mainid) }}"
