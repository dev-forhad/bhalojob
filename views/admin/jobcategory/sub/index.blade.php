...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Sub Category <small>Sub Category</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Sub Category</span> </div>
                            <div class="actions">
                                <a href="{{ route('admin.jscCreate') }}" class="btn btn-xs btn-success"><i
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($alljobservice as $each)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/jscEdit/' . $each->id) }}"  class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
                                                        <a onclick="return confirm('Are you sure you want to delete this item?');"   href="{{ url('admin/jscDelete/' . $each->id) }}"
