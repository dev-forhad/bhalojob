...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Category <small>Category</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Category</span> </div>
                            <div class="actions"> <a href="{{ route('admin.jcCreate') }}" class="btn btn-xs btn-success"><i
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($alljobservice as $each)
                                            <tr>
                                                ...
                                                <td>{{ $each->name }}</td>
                                                <td>
                                                    <a href="{{ url('admin/jcEdit/' . $each->id) }}"  class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>
