...
<div class="form-body">    
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
        ...
        {!! Form::select('country_id', [''=>'Select Country']+$countries, old('country_id', (isset($user))? $user->country_id_bd:$siteSetting->default_country_id), array('class'=>'form-control', 'id'=>'country_id')) !!}
