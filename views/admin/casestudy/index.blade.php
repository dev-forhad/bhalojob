...
@section('content')
    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Case <small>Case</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Case</span> </div>
                            <div class="actions"> <a href="{{ route('admin.caseCreate') }}"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($allcasedata as $each)
                                            <tr>
                                                <th>{{ $i++ }}</th>
                                                <td>{{ $each->name }}</td>
                                                <td>{{ $each->title }}</td>
                                                <td>
                                                    <img width="50px" src="{{ asset('case/' . $each->image) }}"
                                                        alt="">
                                                </td>
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/caseEdit/' . $each->id) }}"     class="btn btn-success btn-sm"><span class="fa fa-pencil"></span>EDIT</a>
                                                    <a onclick="return confirm('Are you sure you want to delete this item?');"   href="{{ url('admin/caseDelete/' . $each->id) }}"
...
@push('scripts')
    <script>
        ...
        function deleteCase(id, is_default) {
