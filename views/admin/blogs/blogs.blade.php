                                    ...
                                    <tbody>
                                        @foreach ($user as $blog)
                                            <tr class="item{{ $blog->id }}">
                                                ...
                                                <td>
                                                {{-- {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $blog->updated_at)->diffForHumans() }} --}}
                                                @if($blog->updated_at)
                                                    {{ \Carbon\Carbon::createFromFormat('Y-m-d H:i:s', $blog->updated_at)->diffForHumans() }}
                                                    @else
                                                        No date available
                                                ...
                                                <td>
                                                    ...
                                                    <button id="popup" class="delete-modal btn btn-danger"
                                                        onClick="delete_blog({{ $blog->id }});"><span
                                ...
                                <div class="modal-body">
                                    ...
                                    <div id="div_show_seo_fields" style="display: none">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="meta_title"
                                                    id="meta_title" autofocus value="{{ old('meta_title') }}">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <textarea class="form-control" name="meta_descriptions" id="meta_descriptions" cols="40" rows="5"
                            ...
                            <form method="POST" files="true" action="{{ asset('/admin/blog') }}"
                                ...
                                <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <select id="cate_id_update" name="cate_id_update[]" class="form-control"
                                                    multiple="multiple">
                                                    @foreach ($categories as $cate)
                                                        <option value="<?php echo $cate->id; ?>">{!! $cate->heading !!}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                    ...
                                    <div class="form-group {{ $errors->has('title_update') ? 'has-error' : '' }}">
                                        <label class="control-label col-sm-3" for="title">Title</label>
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="title_update"
                                                id="title_update" value="{{ old('title_update') }}">
                                    ...
                                    <div id="div_show_seo_fields_for_update" style="display: none">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="title">Meta Description</label>
                                            <div class="col-sm-12">
                                                <textarea class="form-control" name="meta_descriptions_update" id="meta_descriptions_update" cols="40"
