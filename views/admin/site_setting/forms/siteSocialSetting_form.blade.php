...
<div class="form-body">
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'facebook_address') !!}">
        ...
        {!! Form::text('facebook_address', null, [
            'class' => 'form-control',
            'id' => 'facebook_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'google_plus_address') !!}">
        ...
        {!! Form::text('google_plus_address', null, [
            'class' => 'form-control',
            'id' => 'google_plus_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'pinterest_address') !!}">
        ...
        {!! Form::text('pinterest_address', null, [
            'class' => 'form-control',
            'id' => 'pinterest_address',
            'placeholder' => 'Pinterest Address',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'twitter_address') !!}">
        ...
        {!! Form::text('twitter_address', null, [
            'class' => 'form-control',
            'id' => 'twitter_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'instagram_address') !!}">
        ...
        {!! Form::text('instagram_address', null, [
            'class' => 'form-control',
            'id' => 'instagram_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'linkedin_address') !!}">
        ...
        {!! Form::text('linkedin_address', null, [
            'class' => 'form-control',
            'id' => 'linkedin_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'youtube_address') !!}">
        ...
        {!! Form::text('youtube_address', null, [
            'class' => 'form-control',
            'id' => 'youtube_address',
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'tumblr_address') !!}">
        ...
        {!! Form::text('tumblr_address', null, [
            'class' => 'form-control',
            'id' => 'tumblr_address',
            'placeholder' => 'Tumblr Address',
        ]) !!}
    ...
    <div class="form-group {!! APFrmErrHelp::hasError($errors, 'flickr_address') !!}">
        ...
        {!! Form::text('flickr_address', null, [
            'class' => 'form-control',
            'id' => 'flickr_address',
            'placeholder' => 'Flickr Address',
        ]) !!}
