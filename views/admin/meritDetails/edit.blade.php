        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <a href="{{ route('admin.meritIndex') }}">Merit Details</a> <i class="fa fa-circle"></i> </li>
                    <li> <span>Edit Merit Details</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption font-red-sunglo"> <i class="icon-settings font-red-sunglo"></i> <span
                                    class="caption-subject bold uppercase">Merit Details Form</span> </div>
                        </div>
                        <div class="portlet-body form">
                            <form action="{{ route('admin.meritDetailsUpdate') }}" method="post"
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="merit_id" id="" class="form-control">
                                            ...
                                            @foreach ($alldetails as $each)
                                                <option @if ($olduserdata->merit_id === $each->id) selected='selected' @endif
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" value="{{ $olduserdata->date }}" name="date"
                                            class="form-control datepicker" placeholder="Merit Title">
