        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>Merit</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Merit <small>Merit</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Merit</span> </div>
                            <div class="actions"> <a href="{{ route('admin.meritCreate') }}"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allsuccessData as $each)
                                            <tr>
                                                <th>{{ $i++ }}</th>
                                                <td>{{ $each->title }}</td>
                                                <td><img width="50px" src="{{ asset('merit/' . $each->image) }}"
                                                        alt=""></td>
                                                <td>
                                                    <a href="{{ url('admin/meritEdit/' . $each->id) }}"
