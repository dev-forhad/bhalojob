                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="jobDatatableAjax">
                                        <thead>
                                            <tr role="row" class="filter">
                                                <td>{!! Form::select('company_id', ['' => 'Select Company'] + $companies, null, [
                                                    'id' => 'company_id',
                                                    'class' => 'form-control',
                                                ]) !!}</td>
                                                ...
                                                <td><input type="text" class="form-control" name="description"
                                                        id="description" autocomplete="off" placeholder="Job description">
                                                </td>
                                                <td>
                                                    <?php $default_country_id = Request::query('country_id', $siteSetting->default_country_id); ?>
                                                    {!! Form::select('country_id', ['' => 'Select Country'] + $countries, $default_country_id, [
                                                        'id' => 'country_id',
                                                        'class' => 'form-control',
                                                    ]) !!}
