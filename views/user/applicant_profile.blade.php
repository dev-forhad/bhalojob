        ...
        <div class="row">
            <div class="col-md-8">               
                ...
                <div class="job-header">
					...
					<div class="ptsklbx">
					<h3>{{__('Skills')}}</h3>
                     <div id="skill_div">xxxxxx</div>
                    <!-- <div>This hskjfjlkasjflkajfljkjalk asjdlkasdaslkdajs kjsalkjdalksjd</div> -->
					</div>
                ...
                <div class="job-header">
                    <div class="contentbox">
                        <h3>{{__('Experience')}}</h3>
                       <div class="contentbox" id="experience_div"> 
                    This is test things     
                    </div>
                    ...
                    <div class="jobdetail">
                        ...
                        <ul class="jbdetail">
                            ...
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{@$MaritalStatus->marital_status}}</span></div>
                            </li>
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{@$JobExperience->job_experience}}</span></div>
                            </li>
                            <li class="row">
                                ...
                                <div class="col-md-6 col-xs-6"><span>{{@$CareerLevel->career_level}}</span></div>
                            </li>             
                            <li class="row">
