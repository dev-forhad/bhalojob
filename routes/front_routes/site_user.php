...
Route::post('update-profile-image', 'UserController@updateprofileimage')->name('user.imageupdate'); 
...
Route::get('view-resume/{id}', 'UserController@resume')->name('resume.user');
...
Route::post('get-front-profile-skill-edit-form-new/{id}', 'UserController@getFrontProfileSkillEditFormnew')->name('get.front.profile.skill.edit.form-new');
...
Route::put('update-front-profile-skill-certificate/{skill_id}/{user_id}', 'UserController@updateFrontProfileSkillcertificate')->name('update.front.profile.skill.certificate');
Route::put('update-front-profile-skill-driving/{skill_id}/{user_id}', 'UserController@updateFrontProfileSkillDriving')->name('update.front.profile.skill.driving');
