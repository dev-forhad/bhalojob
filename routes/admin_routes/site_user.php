...
Route::post('/eng-jap', 'Admin\UserController@engToJapStore')->name('user.engToJap');
Route::post('/eng-jap/{id}', 'Admin\UserController@engToJapUpdate')->name('user.engToJapUpdate');
...
Route::get('eng-to-jap/{id}', array_merge(['uses' => 'Admin\UserController@engToJap'], $all_users))->name('eng.to.jap.user');
