{!! Form::model($company, array('method' => 'put', 'route' => array('update.company.profile'), 'class' => 'form px-0 px-lg-4', 'files'=>true)) !!}
    <div class="profile-creation-heading-com">
...
<div class="row mt-4">
    <div class="col-md-6">
        <div class="formrow">
			<label class="pt-lg-3 label-design">{{__('Company Logo')}}</label>
...
<div class="row">
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'email') !!}">
    			<label class="label-design">{{__('Email')}}</label>
    			{!! Form::text('email', null, array('class'=>'form-control bg-white', 'id'=>'email', 'placeholder'=>__('Company Email'))) !!}
                {!! APFrmErrHelp::showErrors($errors, 'email') !!} </div>
    </div>
    
    <div class="col-md-6">
            <div class="formrow {!! APFrmErrHelp::hasError($errors, 'password') !!}">
    			<label class="label-design">{{__('Password')}}</label>
    			{!! Form::password('password', array('class'=>'form-control bg-white', 'id'=>'password', 'placeholder'=>__('Password'))) !!}
...
<div class="row">
	...
	<div class="col-md-6 my-2">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'established_in') !!}">
			...
			<label class="label-design">Year of Establishment</label>
			{!! Form::select('established_in', ['' => __('Select Established In')]+MiscHelper::getEstablishedIn(), null, array('class'=>'form-control bg-white', 'id'=>'established_in')) !!}
    ...
    <div class="col-md-6 my-2">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'no_of_employees') !!}">
			...
			<label class="label-design">Company Size</label>
			{!! Form::select('no_of_employees', ['' => __('Select num. of employees')]+MiscHelper::getNumEmployees(), null, array('class'=>'form-control bg-white', 'id'=>'no_of_employees')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'no_of_employees') !!} </div>
    </div>
    
    <div class="col-12 my-2"><label class="label-design">Company Address</label></div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'country_id') !!}">
			{{--<label>{{__('Country')}}</label>--}}
			{!! Form::select('country_id', ['' => __('Select Country')]+$countries, old('country_id', (isset($company))? $company->country_id:$siteSetting->default_country_id), array('class'=>'form-control bg-white', 'id'=>'country_id')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'country_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'state_id') !!}">
			{{--<label>{{__('State')}}</label>--}}
			<span id="default_state_dd"> {!! Form::select('state_id', ['' => __('Select State')], null, array('class'=>'form-control bg-white', 'id'=>'state_id')) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'state_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'city_id') !!}">
			{{--<label>{{__('City')}}</label>--}}
			<span id="default_city_dd"> {!! Form::select('city_id', ['' => __('Select City')], null, array('class'=>'form-control bg-white', 'id'=>'city_id')) !!} </span> {!! APFrmErrHelp::showErrors($errors, 'city_id') !!} </div>
    </div>
    <div class="col-md-6">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'postal_code') !!}">
			{!! Form::text('postal_code', null, array('class'=>'form-control bg-white', 'id'=>'postal_code', 'placeholder'=> 'Postal Code')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'postal_code') !!} </div>
    </div>
    <div class="col-md-6 my-2">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'industry_id') !!}">
			{{--<label>{{__('Industry')}}</label>--}}
			<label class="label-design">Industry Type</label>
			{!! Form::select('industry_id', ['' => __('Select Industry')]+$industries, null, array('class'=>'form-control bg-white', 'id'=>'industry_id')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'industry_id') !!} </div>
    </div>
    <div class="col-md-12">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'description') !!}">
			<label class="label-design">{{__('Description')}}</label>
			{!! Form::textarea('description', null, array('class'=>'form-control bg-white description', 'id'=>'', 'placeholder'=>__('Company details'))) !!}
            {!! APFrmErrHelp::showErrors($errors, 'description') !!} </div>
    </div>
    
    <div class="col-md-12 my-2">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'trade_license_no') !!}">
            <label class="label-design">Business/Trade License No:</label>
			{!! Form::text('trade_license_no', null, array('class'=>'form-control bg-white', 'id'=>'trade_license_no', 'placeholder'=> 'Business/Trade License No:')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'trade_license_no') !!} </div>
    </div>
    <div class="col-md-12 my-2">
        <div class="formrow {!! APFrmErrHelp::hasError($errors, 'rl_no') !!}">
            <label class="label-design">RL No (Only for Recruiting Agency)</label>
            <div class="d-flex">
                <span class="form-control col-lg-1 col-3 font-weight-bold" style="
    background: #dad8d8;
"> RL No</span>
			{!! Form::text('rl_no', null, array('class'=>'form-control bg-white', 'id'=>'rl_no', 'placeholder'=> ' Enter number only')) !!}
            {!! APFrmErrHelp::showErrors($errors, 'rl_no') !!} 
            </div></div>
    </div>
    ...
    <div class="col-md-12 mt-2">
        <div class="formrow">
            <button type="submit" class="switch-button continue-com-btn">{{__('Continue')}} <i class="fa fa-arrow-right px-2" aria-hidden="true"></i></button>
        </div>
    </div>
</div>
