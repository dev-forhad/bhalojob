...
// @dd($langauge); 
 ...
 function profilePercentageCalculation($user, $education, $Experience, $langauge, $pro_summery)
 {    
    // $totalFields = 45;
    $totalFields = 32;
    // user/////////////////
...
// Experience  Profile/////////////////
 ...
 $total= intval(profilePercentageCalculation($user, $education, $Experience, $langauge,$pro_summery));
?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10 col-md-10">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="editbtbn"><a href="{{ route('profilepage') }}"><i
