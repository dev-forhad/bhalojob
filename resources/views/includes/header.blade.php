                        ...
                        <ul>
                            ...
                            <li class="nav-item dropdown userbtn"><div class="login-user-images">{{Auth::user()->printUserImage()}}</div>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="{{ route('profilepage') }}" class="nav-link"><i class="fa fa-user" aria-hidden="true"></i> {{__('My Profile')}}</a> </li>
                            ...
                            <li class="nav-item dropdown userbtn"><div class="login-user-images">{{Auth::guard('company')->user()->printCompanyImage()}}</div>
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item"><a href="{{ route('company.profile.demo') }}" class="nav-link"><i class="fa fa-user" aria-hidden="true"></i> {{__('Company Profile')}}</a></li>
