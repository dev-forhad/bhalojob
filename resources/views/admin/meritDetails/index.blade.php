        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>Merit Details</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage Merit Details <small>Merit</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">Merit Details</span> </div>
                            <div class="actions"> <a href="{{ route('admin.meritDetailsCreate') }}"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($alldetails as $each)
                                            <tr>
                                                ...
                                                <td>{{ $each->details }}</td>
                                                <td>
                                                    <a href="{{ url('admin/meritDetailsEdit/' . $each->mdid) }}"
