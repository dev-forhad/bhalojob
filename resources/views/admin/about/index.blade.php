                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        @php
                                            $i = 1;
                                        @endphp
                                        @foreach ($allaboutdata as $each)
                                            <tr>
                                                <th>{{ $i++ }}</th>
                                                <td>{{ $each->title }}</td>
                                                <td>{{ $each->description }}</td>
                                                <td><img width="50px" src="{{ asset('about/' . $each->lfetimage) }}"
                                                        alt=""></td>
                                                <td><img width="50px" src="{{ asset('about/' . $each->rightimage) }}"
                                                        alt=""></td>
                                                <td>
                                                    @if ($each->status == '1')
                                                        {{ 'Active' }}
                                                ...
                                                <td>
                                                    <a href="{{ url('admin/aboutEdit/' . $each->id) }}"
