        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>FAQ Category</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- BEGIN PAGE TITLE-->
            <h3 class="page-title">Manage FAQ Category <small>FAQ Category</small> </h3>
            <!-- END PAGE TITLE-->
            <!-- END PAGE HEADER-->
                    ...
                    <div class="portlet light portlet-fit portlet-datatable bordered">
                        <div class="portlet-title">
                            <div class="caption"> <i class="icon-settings font-dark"></i> <span
                                    class="caption-subject font-dark sbold uppercase">FAQ Category</span> </div>
                            <div class="actions"> <a href="{{ route('admin.faqcCreate') }}"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($allcategory as $each)
                                            <tr>
                                                ...
                                                <td><img width="50px" src="{{ asset('faq/' . $each->image) }}"
                                                        alt=""></td>
                                                <td>
                                                    <a href="{{ url('admin/faqcEdit/' . $each->id) }}"
                                                        class="btn btn-success btn-sm"><i class="fa fa-pencil" aria-hidden="true"></i> Edit</a>

                                                        <a onclick="return confirm('Are you sure you want to delete this item?');"   href="{{ url('admin/faqcDelete/' . $each->id) }}"
