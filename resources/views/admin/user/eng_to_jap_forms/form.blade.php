...
@php
    ...
    $jp_address = json_decode($languageConvert->jp_address);
    endif;
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td> First Or Middle Name (Alternate Japanese)</td>
                        <td>{{$user->first_name}}</td>

                        <td><input type="text" name="personal_information[first_name_alt]" value="{{(!empty($personal_information->first_name_alt)) ?  $personal_information->first_name_alt: ''}}" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td> Last Name</td>
                    ...
                    <tr>
                        <td> Last Name (Alternate Japanese)</td>
                        <td> {{$user->last_name}}</td>
                        <td><input type="text" name="personal_information[last_name_alt]" value="{{(!empty($personal_information->last_name_alt)) ?  $personal_information->last_name_alt: ''}}" class="form-control">
                        </td>
                    </tr>
                                    ...
                                    <td>
                                        <select class="form-control" id="birth_year" 
                                            ...
                                            @foreach($years as $year)
                                                <option value="{{$year->id}}" <?php if(!empty($user->birth_year) && $user->birth_year == $year->id): echo "selected";endif; ?> >{{$year->year_value}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-control" id="birth_year" 
                                            ...
                                            @foreach($months as $month)
                                                <option value="{{$month->id}}" <?php if(!empty($user->birth_year) && $user->birth_year == $month->id): echo "selected";endif; ?> >{{$month->eng_title}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-control" id="birth_year" 
                                            ...
                                            @foreach($days as $day)
                                                <option value="{{$day->id}}" <?php if(!empty($user->birth_year) && $user->birth_year == $day->id): echo "selected";endif; ?> >{{$day->eng_title}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <td> 
                            <select class="form-control">
                                ...
                                @foreach($genders as $gender)
                                    <option value="{{$gender->id}}" <?php if(!empty($user->gender_id) && $user->gender_id == $gender->id): echo "selected";endif; ?>>{{$gender->gender}}</option>
                                @endforeach
                            </select>
                        </td>
                        <td>
                        ...
                        <td> 
                             <select class="form-control" >
                                ...
                                @foreach($maritalStatus as $status)
                                    <option value="{{$status->id}}" <?php if(!empty($user->marital_status_id) && $user->marital_status_id == $status->id): echo "selected";endif; ?>>{{$status->marital_status}}</option>
                                @endforeach
                            </select>
                         </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="personal_information[jp_country_name]" value="{{$jp_address->jp_country_name??''}}" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>Nationality</td>
                        
                        <td>  {{$user->getCountry('nationality')}}</td>
                        {{--<td>
                           <?php $country_id = old('country_id'); ?>
                            {!! Form::select('personal_information[country_id]', [''=>__('Select Country')]+$countries, $country_id, array('class'=>'form-control required', 'id'=>'country_id')) !!}
                            {!! APFrmErrHelp::showErrors($errors, 'country_id') !!}
                        </td>--}}
                        <td><input type="text" name="personal_information[jp_nationality_name]" value="{{$jp_address->jp_nationality_name??''}}" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>State</td>
                        ...
                        <td><input type="text" name="personal_information[jp_state_name]" value="{{$jp_address->jp_state_name??''}}" class="form-control">
                        </td>
                    </tr>
                    <tr>
                        <td>City</td>
                        ...
                        <td><input type="text" name="personal_information[jp_city_name]" value="{{$jp_address->jp_city_name??''}}" class="form-control">
                        </td>
                    </tr>

                    <tr>
                        <td> Street Address</td>
                        <td> {{$user->bd_village}}</td>
                    ...
                    <tr>
                        ...
                        <select class="form-control">
                                ...
                                @foreach($currentVisas as $visaStatus)
                                    <option value="{{$visaStatus->id}}" <?php if(!empty($user->current_visa_status_id) && $user->current_visa_status_id == $visaStatus->id): echo "selected";endif; ?>>{{$visaStatus->eng_title}}</option>
                                @endforeach
                            </select>
                                ...
                                <tr>
                                    <td>
                                        <select class="form-control" id="jp_visa_expiry_year" 
                                            ...
                                            <option value="" disabled>Year</option>
                                            @foreach($years as $year)
                                                <option value="{{$year->id}}" <?php if(!empty($user->jp_visa_expiry_year) && $user->jp_visa_expiry_year == $year->id): echo "selected";endif; ?> >{{$year->year_value}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-control" id="jp_visa_expiry_year" 
                                            ...
                                            <option value="" disabled>Month</option>
                                            @foreach($months as $month)
                                                <option value="{{$month->id}}" <?php if(!empty($user->jp_visa_expiry_month) && $user->jp_visa_expiry_month == $month->id): echo "selected";endif; ?> >{{$month->eng_title}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-control" id="jp_visa_expiry_year" 
                                            ...
                                            <option value="" disabled>Day</option>
                                            @foreach($days as $day)
                                                <option value="{{$day->id}}" <?php if(!empty($user->jp_visa_expiry_day) && $user->jp_visa_expiry_day == $day->id): echo "selected";endif; ?> >{{$day->eng_title}}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        ...
                        <td> {{$user->state_id_bd ?? $user->state->state}} </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td> {{$user->city_id_bd ?? $user->city->city}} </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="personal_information[jp_mother_tongue]" value="{{(!empty($personal_information->jp_mother_tongue)) ?  $personal_information->jp_mother_tongue : ''}}" class="form-control "></td>
                    </tr>
                    <tr>
                        <td>Address</td>
                    ...
                    <tr>
                        ...
                        <td style="max-width: 300px;">{{$user->profileSummary->first()->summary??'N/A'}}</td>
                        <td><textarea rows="4" cols="50" type="text" name="personal_information[jp_self_summary]" class="form-control ">{{(!empty($personal_information->jp_self_summary)) ?  $personal_information->jp_self_summary : ''}}</textarea></td>
                    </tr>
                    </tbody>
                </table>
            </div>
