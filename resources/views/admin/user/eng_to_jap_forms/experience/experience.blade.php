                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-control"  required>
                                                        <option value="" disabled>Year</option>
                                                        @foreach($years as $year)
                                                            <option value="{{$year->id}}" <?php if(!empty($experience->pass_year) && $experience->pass_year == $year->id): echo "selected";endif; ?> >{{$year->year_value}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <select class="form-control"  required>
                                                        <option value="" disabled>Month</option>
                                                        @foreach($months as $month)
                                                            <option value="{{$month->id}}" <?php if(!empty($experience->pass_month) && $experience->pass_month == $month->id): echo "selected";endif; ?> >{{$month->eng_title}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                @endif
                                            ...
                                            <tr>
                                                @if($experience->is_currently_working)
                                                 <td>
                                                   ...
                                                   <input type="text" name="currently_working[<?php echo $experience->slug?>][is_currently_working]" value="{{$workExpe->is_currently_working ?? 'No'}}" class="form-control">
                                                </td>
                                                <td>
                                                    &nbsp;
                                                </td>
