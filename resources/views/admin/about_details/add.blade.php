        ...
        <div class="page-content">
            ...
            <div class="page-bar">
                <ul class="page-breadcrumb">
                    ...
                    <li> <span>Add About Details</span> </li>
                </ul>
            </div>
            <!-- END PAGE BAR -->
            <!-- END PAGE HEADER-->
                ...
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <form action="{{ route('admin.aboutDetailsSave') }}" method="post"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="date" name="date" class="form-control datepicker"
                                            placeholder="About Details Title">
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="inputEmail4">Details</label>
                                        <textarea type="text" name="details" class="form-control" placeholder="About Details "></textarea>
                                    </div>
                                </div>
