<div class="modal-body">
    <div class="form-body">
        ...
        <div class="form-group" id="div_major_subjects">
            ...
            ?>
            {!! Form::select('major_subjects[]', $majorSubjects, $profileEducationMajorSubjectIds, array('class'=>'form-control select2-multiple-mejor', 'id'=>'major_subjects', 'multiple'=>'multiple')) !!}
