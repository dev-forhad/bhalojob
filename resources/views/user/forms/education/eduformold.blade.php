<div class="modal-body">
    <div class="form-body">
        ...
        <div class="row">
            ...
            {{--<div class="form-group col-md-12" id="div_degree_type_id">
            ...
            <div class="form-group col-md-12" id="div_degree_title">
            ...
            <div class="form-group col-md-12" id="div_major_subjects">
             ...
             <div class="form-group col-md-4" id="div_country_id">
        ...
        <div class="form-group col-md-4" id="div_state_id">
        ...
        <div class="form-group col-md-4" id="div_city_id">
            ...
            <div class="form-group col-md-12" id="div_date_completion">
            ...
            <div class="form-group col-md-12" id="div_degree_result">
            ...
            <div class="form-group col-md-12" id="div_result_type_id">
