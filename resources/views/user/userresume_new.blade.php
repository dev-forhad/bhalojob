            ...
            <div class="row">
                ...
                <div class="col-md-9 col-sm-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <table class="table-responsive borderremove">
                                            <tbody>
                                            <tr>
                                                <td style="width:20%!important"  style="border:none;" class="border-right-none  border-bottom-dotted border-top-solid border-left-solid">名前</td> <!--Name-->
                                              
                                                <td  style="width:30%!important"  style="border:none; text-align: right;" class="border-left-none border-right-dotted border-bottom-dotted border-top-solid">{{ @$personalInfo->first_name}} {{ @$personalInfo->last_name}}</td>
                                                <td style="text-align: center;" colspan="3" rowspan="2" class="border-left-none border-top-solid border-right-solid">{{$gender->jp_gender ?? ''}}</td>
                                                <td style="width:30%!important"   rowspan="3" class="border-right-none border-top-none">
                                            ...
                                            <tr>
                                                <td class="border-top-none border-right-none border-left-solid"> 名前 </td> <!--Name-->
                                                <td class="border-top-none border-left-none border-right-dotted">{{ @$personalInfo->first_name_alt}} {{ @$personalInfo->last_name_alt}} </td>
                                               
                                            </tr>
                                            <tr>
                                                <td class="border-right-none border-left-solid">生年月日</td> <!--Dob-->
                                                <td colspan="4" style="text-align:right" class="border-left-none  border-right-solid">{{@$Byear->jp_year_value}} - {{@$Bmonths->jp_title}} - {{@$Bdays->jp_title}} ({{@$age_total}})</td>
                                            </tr>
                                            
                                            <tr>
                                                <td class="border-left-none"  width=""> 住所 </td> <!--Address-->
                                                <td colspan="4">{{$jp_address->jp_state_name??''}} - {{$jp_address->jp_city_name ?? ''}} - {{$user->bd_village}}</td>
                                                <td class="text-center border-right-none">携帯番号</td> <!--Mobile No-->
                                            </tr>
                                            <tr> 
                                                <td class="border-left-none" colspan="5" width="50%!important">現住所 <!--Present Address--> (郵便番号) {{$user->bd_postal_code}}</td> <!--Postal code-->
                                                <td class="text-center border-right-none">{{$user->phone ?? ''}}</td>
                                            </tr>
                                            <tr>
                                                <td class="border-left-none" colspan="5" rowspan="4"> 地区 <!--District-->: {{$jp_address->jp_state_name??''}}  タナ <!--Thana-->: {{$jp_address->jp_city_name ?? ''}} 村 <!--Village-->: {{$user->bd_village}} ハウスナンバー <!--House No-->: {{$user->bd_address}}  </td>
                                                <td class="text-center border-right-none">電子メールアドレス</td> <!--Email Address-->
                                            </tr>
                                            <tr>
                                                <td class="text-center border-right-none">{{$user->email}}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center border-right-none">国籍</td> <!--Nationality-->
                                            </tr>
                                            <tr>
                                                <td class="text-center border-right-none">{{ @$personalInfo->jp_nationality_name}}</td>
                                            </tr>
                                            <tr>
                                                <td class="text-center border-bottom-solid">年</td><!--Year-->
                                                <td class="text-center border-bottom-solid" class="border-bottom-solid">月</td><!--Month-->
                                                <td class="text-center border-bottom-solid" style="width:60%; font-weight: 600" colspan="4">学歴</td><!--Educational History-->
                                            </tr> 
                                            @foreach($education as $data)
                                            <tr>
                                                <td class="border-top-none border-right-dotted border-bottom-dotted">{{$data->getEntrance('jp_year_value')}}</td>
                                                <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$data->entranc_month->jp_title}}</td>
                                                <td  class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">
                                                    <div class="w-100">
                                            ...
                                            <tr>
                                                <td class="border-top-none border-right-dotted border-bottom-dotted">{{$data->getPass('jp_year_value')}}</td>
                                                <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$data->pass_months->jp_title}}</td>
                                                <td class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">{{ collect($educationInfo)[$data->id]->institution_name??'' }}	</td>
                                            </tr>
                                            @endforeach
                                            <tr>
                                                <td colspan="6"></td>
                                            ...
                                            <tr>
                                                <td class="text-center border-left-none">年</td><!--Year-->
                                                <td class="text-center" >月</td><!--Month-->
                                                <td class="text-center" style="width:60%; font-weight: 600" colspan="4">実務経験</td><!--Work Experience-->
                                            </tr>
                                            ...
                                            <tr>
                                                <td class="border-top-none border-right-dotted border-bottom-dotted">{{$exper->entryYear->jp_year_value }}</td>
                                                <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$exper->entryMonth->jp_title}}</td>
                                                <td class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">
                                                    <div class="w-100">
                                                        <div class="w-50 float-left">
                                                            {{$workExpe['company']??''}}
                                            ...
                                            <tr>
                                                <td class="border-top-none border-right-dotted border-bottom-dotted">{{$exper->reYear->jp_year_value ?? '今、働いている'}}</td>
                                                <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$exper->reMonth->jp_title ?? '今、働いている'}}</td>
                                                <td class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">{{$workExpe['company']}}	</td>
                                            </tr>
                                            @endforeach
                                            @endif
                                            <tr>
                                            ...
                                            <tr>
                                                <td class="border-top-solid border-bottom-solid text-center border-right-none">年</td><!--Year-->
                                                <td class="border-top-solid border-bottom-solid text-center border-left-dotted border-right-dotted">月</td><!--Month-->
                                                <td class="border-top-solid border-bottom-solid text-center border-left-none" style="width:60%; font-weight: 600" colspan="4">認証</td><!--Certification-->
                                            </tr>
                                            
                                            @foreach($profiledrivingSkills as $skill)
                                            <tr>
                                               <td class="border-top-none border-right-dotted border-bottom-dotted">{{$skill->getPass('jp_year_value')}}</td>
                                               <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$skill->getMonth('jp_title')}}</td>
                                               <!--<td style="width:60%" colspan="4">{{$skill->categoryName('eng_title')}}</td>-->
                                               <td class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">運転免許証</td>
                                            </tr>
                                            @endforeach
                                            ...
                                            <tr>
                                               <td class="border-top-none border-right-dotted border-bottom-dotted">{{$skill->getPass('jp_year_value')}}</td>
                                               <td class="border-top-none border-left-none border-right-dotted border-bottom-dotted">{{$skill->getMonth('jp_title')}}</td>
                                               <td class="border-top-none border-left-none border-bottom-dotted" style="width:60%" colspan="4">{{$skill->getLangtype('jp_title')}}</td>
                                            </tr>
                                            @endforeach
                                            @endif
                                            ...
                                            <tr>
                                                <td class="border-top-solid" colspan="4">自己紹介（趣味、得意なこと、やる気）</td><!--Self Introduction(Hobbies,Strength,good at, motivation)-->
                                                <td class="border-top-solid">配偶者の有無</td><!--Marital Status-->
                                                <td class="border-top-solid" >{{@$Mstatus->jp_marital_status}}</td>
                                            </tr>
                                            <tr>
                                                <td rowspan="5" colspan="4">{{$user->getProfileSummary('summary') ?? ''}}</td>
                                                <td>子供たち</td><!--Children-->
                                            ...
                                            <tr>
                                                <td style="width:110px; display:flex;">{{$language->getLanguage('native')}} レベル </td>
                    ...
                    <div class="my-3" style="text-align: center;">
                        ...
                        <input style="" type="button" id="downloadButton" class="btn btn-primary"
                               value="履歴書の印刷"/><!--Print Resume-->
