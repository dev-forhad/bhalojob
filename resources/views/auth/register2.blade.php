...
<div class="userbtns">
    ...
    <p class="cat">Choose Your Category</p>
         <ul class="nav nav-tabs">
             ...
             <li class="nav-item"><a class="nav-link {{($c_or_e == 'candidate')? 'active':''}}" href="{{route('candidate.register')}}" aria-expanded="true">Candidate</a></li>
              {{-- {{__('求職者')}} --}}
             <li class="nav-item"><a class="nav-link {{($c_or_e == 'employer')? 'active':''}}" href="{{route('employee.registree') }}" aria-expanded="false">Employer</a></li>
             {{-- {{__('企業向け')}} --}}
