...
<style>
 ...
 <section class="v-code-main-box col-lg-8 col-12 overflow-hidden m-auto px-lg-0  px-lg-0 px-0">
    ...
    <div class="col-lg-10 col-12 m-auto">
        <div class="col-lg-10 col-12 m-auto">
            ...
            @endif
           <form action="{{route('authorize.post')}}" method="POST" class="text-center">
             @csrf
                <div>
                    <label class="set-pass-label" for="v-code">@lang('Authentication Code')</label>
                    <div class="verification-code-wrapper m-auto bg-transparent mx-0 px-0">
                         <div class="verification-area"> 
                              
                                <div class="mb-3">
                                    
                                    <div class="verification-code">
                                        <input type="text" name="code" id="verification-code" class="form-control overflow-hidden" max-lenth="6" required autocomplete="off">
                                        <div class="boxes">
                                            <span>-</span>
                                            <span>-</span>
                                            <span>-</span>
        ...
        $('#verification-code').on('input', function () {
            ...
            for (let index = 0; index < 6; index++) {
                if (index < $(this).val().length) {
                    $($('.boxes span')[index]).html($(this).val()[index]);
                } else {
                    $($('.boxes span')[index]).html('');
                }
            }
