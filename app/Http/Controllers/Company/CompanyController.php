...

{
    ...
    public function companyProfileDemo()

    {
        ...
        return view('company.edit_profile_demo')
    ...
    {  
        ...
        $company->rl_no = $request->input('rl_no');
...
// 		Subscription::where('email', 'like', $company->email??null)->delete();
...
// 		}
        ...
        return \Redirect::route('company.profile.demo');
...

    {
        ...
        // $jobs = Auth::guard('company')->jobs()->paginate(10);
        
        // $jobs = Company::with('jobs')->get();
