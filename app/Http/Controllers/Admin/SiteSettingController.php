...

{
...

    {
       ...
       // echo '<pre>'; print_r($siteSetting); exit();
        ...
        $siteSetting->yahoo_app_id = $request->input('yahoo_app_id');
        $siteSetting->yahoo_app_secret = $request->input('yahoo_app_secret');
        ...
        $siteSetting->user_reviews_title = $request->input('user_reviews_title');
        $siteSetting->user_reviews_short_title = $request->input('user_reviews_short_title');
