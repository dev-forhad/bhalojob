...

{
...

    {
        ...
        return $this->hasMany('App\ProfileExperience', 'user_id', 'id')->orderBy('pass_year','asc');
    }
...

    {
        ...
        return $this->hasMany('App\ProfileEducation', 'user_id', 'id')->orderBy('pass_year','asc');
    }
...

    {
        ...
        return $this->hasMany('App\ProfileSkill', 'user_id', 'id')->whereNotNull('lang_id');
    }
    public function profiledrivingSkills()

    {

        return $this->hasMany('App\ProfileSkill', 'user_id', 'id')->whereNotNull('driving_class_id');
    }
