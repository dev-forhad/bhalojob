        ...
        if ($settings = SiteSetting::findOrFail(1272)) {
            ...
            $this->app['config']['services'] = [
                ...
                'facebook' => [
                   ...
                   'redirect' => 'http://bhalojob.com/login/jobseeker/facebook/callback',
                ...
                'yahoo' => [
                    'client_id' => $settings->yahoo_app_id,
                    'client_secret' => $settings->yahoo_app_secret,
                    'redirect' => url('login/jobseeker/yahoo/callback'),
                ],

                'linkedin' => [
                    'client_id' => $settings->linkedin_app_id,
                    'client_secret' => $settings->linkedin_app_secret,
                    'redirect' => url('login/jobseeker/linkedin/callback'),
                ],
