...
class DataArrayHelper
{
    ...
    {
        $array = Language::select('languages.lang', 'languages.iso_code')->active()->sorted()->pluck('languages.lang', 'languages.iso_code')->toArray();
        return $array;
    }
    public static function languagesTypeCodeArray()
    {
        $array = Language::select('languages.id','languages.native')->active()->sorted()->pluck('languages.native','languages.id')->toArray();
        return $array;
    }
    public static function drivingClassCodeArray()
    {
        $array = DrivingClass::select('driving_classes.id','driving_classes.class_name')->active()->sorted()->pluck('languages.class_name','languages.id')->toArray();
        return $array;
    }
