...
class ProfileEducation extends Model
{
    ...
    public function degreeLevelItem()
    {
    ...
    public function entranc_month(){
        return $this->belongsTo('App\Models\Month', 'entrance_month', 'id');
    }
    ...
    public function pass_months(){
        return $this->belongsTo('App\Models\Month', 'pass_month', 'id');
    }
